...
var _tourSwiper = require("./modules/tour-swiper");
var _instructorSwiper = require("./modules/instructor-swiper");
...
var _heroVideo = require("./modules/hero-video");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  (0, _tourSwiper.initTourSwiper)(true);
  (0, _instructorSwiper.initInstructorSwiper)(true);
  (0, _reviewSwiper.initReviewSwiper)(true);
  (0, _advantagesSwiper.initAdvantagesSwiper)(true);
  (0, _gallerySwiper.initGallerySwiper)(true);
  (0, _heroSwiper.initHeroSwiper)(true);
  (0, _heroVideo.initVideo)();
...
},{"./modules/advantages-swiper":2,"./modules/form-validate/form":4,"./modules/gallery-swiper":10,"./modules/hero-swiper":11,"./modules/hero-video":12,"./modules/instructor-swiper":13,"./modules/modals/init-modals":14,"./modules/review-swiper":16,"./modules/tour-swiper":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
var initAdvantagesSwiper = exports.initAdvantagesSwiper = function initAdvantagesSwiper() {
  var swiperWrapper = document.querySelector('[advantages-swiper]');
  var buttonPrev = document.querySelector('[advantages-swiper-btn-prev]');
  var buttonNext = document.querySelector('[advantages-swiper-btn-next]');
...
var initGallerySwiper = exports.initGallerySwiper = function initGallerySwiper(isLoop) {
  var swiperWrapper = document.querySelector('[gallery-swiper]');
  var buttonPrev = document.querySelector('[gallery-swiper-btn-prev]');
  var buttonNext = document.querySelector('[gallery-swiper-btn-next]');
  return new window.Swiper(swiperWrapper, {
    loop: isLoop,
    slidesPerView: 2,
    navigation: {
...
var initHeroSwiper = exports.initHeroSwiper = function initHeroSwiper(isLoop) {
  var swiperWrapper = document.querySelector('[hero-swiper]');
  var buttonPrev = document.querySelector('[advantages-swiper-btn-prev]');
  var buttonNext = document.querySelector('[advantages-swiper-btn-next]');
  return new window.Swiper(swiperWrapper, {
    loop: isLoop,
...
var poster = container.querySelector('[data-poster="video"]');
var button = container.querySelector('[data-button="btn-video"]');
...
exports.initInstructorSwiper = void 0;
var initInstructorSwiper = exports.initInstructorSwiper = function initInstructorSwiper(isLoop) {
  var swiperWrapper = document.querySelector('[instructor-swiper]');
  var buttonPrev = document.querySelector('[instructor-swiper-btn-prev]');
  var buttonNext = document.querySelector('[instructor-swiper-btn-next]');
  return new window.Swiper(swiperWrapper, {
    loop: isLoop,
    slidesPerView: 4,
    breakpoints: {
...
exports.initReviewSwiper = void 0;
var initReviewSwiper = exports.initReviewSwiper = function initReviewSwiper(isLoop) {
...
exports.initTourSwiper = void 0;
var initTourSwiper = exports.initTourSwiper = function initTourSwiper(isLoop) {
  var swiperWrapper = document.querySelector('[tour-swiper]');
  var buttonPrev = document.querySelector('[tour-swiper-btn-prev]');
  var buttonNext = document.querySelector('[tour-swiper-btn-next]');
  return new window.Swiper(swiperWrapper, {
    loop: isLoop,
    slidesPerView: 3,
    breakpoints: {
